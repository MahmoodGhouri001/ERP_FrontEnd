    ...
    return (
        <div className="sidebar-container">
            <div className="menu">
                ...
                <Link to="/products"><div className="menu-item"><i className="icon-sidebar"><MdOutlineProductionQuantityLimits /></i> Products</div></Link>
                <Link to="/sales-orders"><div className="menu-item"><i className="icon-sidebar"><MdOutlineAddShoppingCart /></i>Orders</div></Link>
                <Link to="/manage-stores"><div className="menu-item"><i className="icon-sidebar"><FaCodeBranch /></i>Branches</div></Link>
                <Link to="/billing"><div className="menu-item"><i className="icon-sidebar"><MdOutlinePayment /></i>Billing</div></Link>
